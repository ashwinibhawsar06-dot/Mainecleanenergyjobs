            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="sjs-div">
						...
						<div class="morejobs"><a href="/jobs">See more jobs<img decoding="async" src="<?php echo home_url() ?>/wp-content/uploads/2024/01/right-arrow.svg"></a></div>
                    </div>
                </div>
            </div>
        </div>
